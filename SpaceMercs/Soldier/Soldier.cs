...
namespace SpaceMercs {
  class Soldier : IEntity {
    ...
    public void Display(bool bLabel, bool bStatBars, bool bShowEffects, float fViewHeight) {
      ...
      GL.PushMatrix();
      GL.Translate(X + 0.5, Y + 0.5, Const.EntityLayer);
      GL.Rotate(Facing + 180.0, Vector3d.UnitZ);
      GL.Scale(Race.Scale, Race.Scale, 1.0);
      GL.Begin(BeginMode.Quads);
      GL.TexCoord2(0.0, 0.0); GL.Vertex3(-0.5, -0.5, 0);
      GL.TexCoord2(1.0, 0.0); GL.Vertex3(0.5, -0.5, 0);
      GL.TexCoord2(1.0, 1.0); GL.Vertex3(0.5, 0.5, 0);
      GL.TexCoord2(0.0, 1.0); GL.Vertex3(-0.5, 0.5, 0);
      GL.End();
      GL.PopMatrix();
      if (bLabel) {
        GL.PushMatrix();
      ...
      if (bStatBars) {
        ...
        GL.Color3(1.0, 1.0, 1.0);
        GL.PushMatrix();
        GL.Translate(X + 0.5, Y + 0.25, Const.GUILayer);
        GL.Scale(Race.Scale, Race.Scale, 1.0);
        GraphicsFunctions.DisplayFractBar(Color.FromArgb(255, 80, 255, 80), Color.Red, -0.5f, 0.7f, 1.0f, 0.09f, Health, MaxHealth);
        GraphicsFunctions.DisplayFractBar(Color.FromArgb(255, 255, 255, 0), Color.Gray, -0.5f, 0.8f, 1.0f, 0.09f, Stamina, MaxStamina);
        if (MaxShields > 0) GraphicsFunctions.DisplayFractBar(Color.FromArgb(255, 50, 100, 255), Color.FromArgb(255, 50, 50, 50), -0.5f, 0.9f, 1.0f, 0.09f, Shields, MaxShields);
        GL.PopMatrix();
      ...
      GL.PushMatrix();
      GL.Translate(X + 1.0, Y + 0.25f, Const.EntityLayer);
    ...
    // Display options
    public void DisplaySoldierDetails(bool bSelected, bool bHover) {
      ...
      GraphicsFunctions.DisplayFractBar(Color.FromArgb(255, 80, 255, 80), Color.Red, Const.GUIPanelWidth * 0.02f, TopBar, Const.GUIPanelWidth * 0.75f, 0.01f, Health, MaxHealth);
      GraphicsFunctions.DisplayFractBar(Color.FromArgb(255, 255, 255, 0), Color.Gray, Const.GUIPanelWidth * 0.02f, TopBar + 0.02f, Const.GUIPanelWidth * 0.75f, 0.01f, Stamina, MaxStamina);
