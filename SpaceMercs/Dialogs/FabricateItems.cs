...
namespace SpaceMercs.Dialogs {
  partial class FabricateItems : Form {
    ...
    private void btConstruct_Click(object sender, EventArgs e) {
      ...
      if (newType is ArmourType) newItem = new Armour(newType as ArmourType, armourMat, lvl);
      else if (newType is WeaponType) newItem = new Weapon(newType as WeaponType, lvl);
    ...
    private void dgConstruct_DoubleClick(object sender, EventArgs e) {
      ...
      ItemType it = (ItemType)dgConstruct.SelectedRows[0].Tag;
      if (it == null) return;
    ...
    private void dgInventory_DoubleClick(object sender, EventArgs e) {
      ...
      Tuple<Soldier, IItem> tp = (Tuple<Soldier, IItem>)dgInventory.SelectedRows[0].Tag;
      if (tp == null || tp.Item2 == null) return;
