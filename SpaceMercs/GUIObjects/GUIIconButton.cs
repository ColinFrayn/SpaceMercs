...
namespace SpaceMercs {
  class GUIIconButton : GUIObject {
    ...
    public GUIIconButton(GameWindow parentWindow, int TextureID, double tx, double ty, double tw, double th, double x, double y, double w, double h, GUIIconButton_Trigger trigger = null, object dat = null) {
      Window = parentWindow;
      Alpha = 0.4f;
      TX = tx;
      TY = ty;
