...
namespace SpaceMercs {
    public static class Const {
        ...
        public const double ArmourCostExponent = 5d; // Affects cost scaling for armour based on how much better it is than the base
        ...
        public const double MissionExperienceScale = 0.8d; // Scale for experience gained for finishing a mission
        public const double MissionExperienceBase = 1.55d; // Scale for experience gained for finishing a mission (base of exponent)
        public const double MissionLevelBase = 1.1d; // Scale for experience gained for finishing a mission (base of exponent for level count)
        ...
        public const double ColonyMissionGrowthRate = 0.04d; // When completing an average colony mission, reduce the time to next growth of the current colony by this fraction of the current growth cycle. Scale by difficulty & length.
        ...
        public const double CreatureFrequencyScale = 210;   // The larger this is, the fewer creatures we put in each level.
        ...
        public const double ShipRepairCostScale = 0.1;  // Fraction of calculated value required to repair 100%
