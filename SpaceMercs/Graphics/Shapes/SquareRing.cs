...
namespace SpaceMercs.Graphics.Shapes {
    internal static class SquareRing {
        ...
        public static GLShape Flat { get { if (_squareRing is null) { _squareRing = Build(); } return _squareRing; } }
        ...
        private static GLShape Build() {
            VertexPos3D[] vertices = new VertexPos3D[] {
                ...
                new VertexPos3D(new Vector3(0.15f, 0.15f, 0f)),
                new VertexPos3D(new Vector3(0.85f, 0.15f, 0f)),
                new VertexPos3D(new Vector3(0.85f, 0.85f, 0f)),
                new VertexPos3D(new Vector3(0.15f, 0.85f, 0f)),
              };
