...
namespace SpaceMercs {
  static class Textures {
    ...
    public static double BuildingTextureWidth { get { return (double)(Textures.TexSize - 1) / Textures.BuildingTextureData.Width; } }
    public static double BuildingTextureHeight { get { return (double)(Textures.TexSize - 1) / Textures.BuildingTextureData.Height; } }
    public static double ItemTextureWidth { get { return (double)(Textures.TexSize - 1) / Textures.ItemTextureData.Width; } }
    public static double ItemTextureHeight { get { return (double)(Textures.TexSize - 1) / Textures.ItemTextureData.Height; } }
    public static Tuple<double, double> GetTexCoords(MiscTexture tex) {
      int xpos = (int)tex & 3, ypos = (int)tex / 4;
      double tx = (double)((xpos * Textures.TexSize) + 0.5) / Textures.MiscTextureData.Width;
      double ty = (double)((ypos * Textures.TexSize) + 0.5) / Textures.MiscTextureData.Height;
      return new Tuple<double, double>(tx, ty);
    }
    public static Tuple<double, double> GetTexCoords(ShipEquipment se) {
      double tx = (double)((se.TextureX * Textures.TexSize) + 0.5) / Textures.BuildingTextureData.Width;
      double ty = (double)((se.TextureY * Textures.TexSize) + 0.5) / Textures.BuildingTextureData.Height;
      return new Tuple<double, double>(tx, ty);
    }
    public static Tuple<double, double> GetTexCoords(ItemType it) {
      ...
      double tx = (double)((it.TextureX * Textures.TexSize) + 0.5) / Textures.ItemTextureData.Width;
      double ty = (double)((it.TextureY * Textures.TexSize) + 0.5) / Textures.ItemTextureData.Height;
      return new Tuple<double, double>(tx, ty);
    }
    ...
    public static int iPlanetHalo;
    public static byte[] bytePlanetHalo;
    public static int iStarTexture;
    public static byte[] byteStarTexture;
    public static int iShipHalo;
    ...
    public static void InitialiseTextures(string strGraphicsDir) {
    ...
    public static int GetMiscTexture() {
    ...
    public static int GetMiscTextureTransparent() {
      int id = GL.GenTexture();
      GL.BindTexture(TextureTarget.Texture2D, id);
      GL.TexEnv(TextureEnvTarget.TextureEnv, TextureEnvParameter.TextureEnvMode, (float)TextureEnvMode.Modulate);
    ...
    public static int GetBuildingTexture() {
      int id = GL.GenTexture();
      GL.BindTexture(TextureTarget.Texture2D, id);
      GL.TexEnv(TextureEnvTarget.TextureEnv, TextureEnvParameter.TextureEnvMode, (float)TextureEnvMode.Modulate);
    ...
    public static int GetItemTexture() {
      int id = GL.GenTexture();
      GL.BindTexture(TextureTarget.Texture2D, id);
      GL.TexEnv(TextureEnvTarget.TextureEnv, TextureEnvParameter.TextureEnvMode, (float)TextureEnvMode.Modulate);
