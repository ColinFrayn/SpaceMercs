...
namespace SpaceMercs.Graphics
{
    internal class VertexPos2DTex : IVertex
    {
        ...
        public static readonly VertexInfo _VertexInfo = new VertexInfo(typeof(VertexPos2DTex), new VertexAttribute(nameof(Position), 0, 2, 0), new VertexAttribute(nameof(Texture), 1, 2, 2));
