...
namespace SpaceMercs.MainWindow {
  ...
  public class VertexInfo {
    ...
    public void SetupVertexAttribs() {
      foreach (VertexAttribute attr in VertexAttributes) {
        GL.VertexAttribPointer(attr.Index, attr.ComponentCount, VertexAttribPointerType.Float, false, SizeInBytes, attr.Offset);
  ...
  public readonly struct VertexPosCol {
    ...
    private static readonly VertexInfo _VertexInfo = new VertexInfo(typeof(VertexPosCol), new VertexAttribute("Position", 0, 2, 0), new VertexAttribute("Colour", 1, 4, 2));
    public static int SizeInBytes { get { return _VertexInfo.SizeInBytes; } }
    public static void SetupVertexAttribs() => _VertexInfo.SetupVertexAttribs();
