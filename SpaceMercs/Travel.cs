...
namespace SpaceMercs {
  ...
  class Travel {
    ...
    public void Display(IGraphicsContext currentContext) {
      ...
      //  Task specific stuff
      if (PlayerTeam.CurrentMission == null) DrawTravelProgress(currentContext);
    ...
    private void DrawTravelProgress(IGraphicsContext currentContext) {
      // Set up the text
      ...
      aoTravelFrom.DrawSelected(currentContext,6);
      GL.PopMatrix();
      GL.PushMatrix();
      GL.Translate(0.75, 0.42, 0.0);
      GL.Scale(0.025 / ParentView.Aspect, 0.025, 0.025);
      GL.Rotate(90.0, Vector3d.UnitY);
      aoTravelTo.DrawSelected(currentContext,6);
      GL.PopMatrix();
    }
