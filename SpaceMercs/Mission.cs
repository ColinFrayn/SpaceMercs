...
namespace SpaceMercs {
  ...
  class Mission {
    ...
    public Mission(XmlNode xml, HabitableAO loc) {
      ...
      TimeCost = Double.Parse(xml.SelectSingleNode("TimeCost").InnerText);
    ...
    public static Mission CreateRepairMission(Race rc, double dTime, double reward) {
    ...
    public static Mission CreateSalvageMission(Race rc, int dDiff, double dTime) {
